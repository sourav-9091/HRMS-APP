...
class KIMSPart2 extends StatefulWidget {
  final String date;
  final String uhidNo;
  final String billNo;
  final String name;
  ...
  @override
  State<KIMSPart2> createState() => _KIMSPart2State();
}

bool isProcessTrue = false;

class _KIMSPart2State extends State<KIMSPart2> {
