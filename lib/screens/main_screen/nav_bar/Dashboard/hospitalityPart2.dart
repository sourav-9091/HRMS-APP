...
class HOSPITALITYPart2 extends StatefulWidget {
  final String date;
  final String service;
  final int cost;
  const HOSPITALITYPart2(
      {super.key,
      required this.date,
  ...
  @override
  State<HOSPITALITYPart2> createState() => _HOSPITALITYPart2State();
}

bool isProcessTrue = false;

class _HOSPITALITYPart2State extends State<HOSPITALITYPart2> {
